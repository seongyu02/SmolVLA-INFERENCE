#!/bin/bash
# smolvla_bridge_direct_224_lora_node 래퍼 스크립트
...
NODE_BIN="$HOME/SmolVLA/SmolVLA-INFERENCE/ros2/install/e6_vla_ros/lib/e6_vla_ros/smolvla_bridge_direct_224_lora_node"
