...
#  SmolVLA 7D LoRA 濡쒕큸 ?대씪?댁뼵????Terminal 2 (run_server_7d_lora.sh 癒쇱?)
#
# ?? ?⑥씪 臾몄옣 ?ㅽ뻾 (沅뚯옣) ?????????????????????????????????????????????????
#
#   bash scripts/run_client_7d_lora.sh
#   bash scripts/run_client_7d_lora.sh --config examples/e6/config_orange_7d_lora.yaml
#
# ?? FSM stage ?쒖뼱 (?좏깮) ?????????????????????????????????????????????????
#
#   bash scripts/run_client_7d_lora.sh --config examples/e6/config_orange_fsm_7d_lora.yaml
#
# ?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧?먥븧
...
DEFAULT_CONFIG="$REPO/examples/e6/config_orange_7d_lora.yaml"
...
echo "=============================="
echo " SmolVLA 7D LoRA robot client"
echo " server : 127.0.0.1:8002"
