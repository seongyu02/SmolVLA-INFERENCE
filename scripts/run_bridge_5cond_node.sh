#!/bin/bash
# smolvla_bridge_5cond_node 래퍼 스크립트 (Orange-512 5조건 비교 추론)
...
NODE_BIN="$HOME/SmolVLA/SmolVLA-INFERENCE/ros2/install/e6_vla_ros/lib/e6_vla_ros/smolvla_bridge_5cond_node"
