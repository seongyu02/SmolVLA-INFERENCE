...
# smolvla_bridge_direct_node 래퍼 스크립트 경로
# (venv_SmolVLA310 Python + CUDA lib + ROS2 pypath 설정 후 노드 실행)
_BRIDGE_DIRECT_SH = os.path.expanduser(
    "~/SmolVLA/SmolVLA-INFERENCE/scripts/run_bridge_direct_node.sh"
)
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            default_value=(
                ...
                "smolvla_orange_v3_224_7d_chunk50_action10_100000steps/"
        ...
        ExecuteProcess(
            cmd=[
                _BRIDGE_DIRECT_SH,
                "--ros-args",
                "-r", "__node:=smolvla_bridge_direct_node",
