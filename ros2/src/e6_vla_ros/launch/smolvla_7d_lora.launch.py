...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("server_port",       default_value="8002"),
        ...
        # ── 노드 2: smolvla_bridge_7d_node (HTTP POST /act, 7D) ─────────────
        Node(
            package="e6_vla_ros",
            executable="smolvla_bridge_7d_node",
            name="smolvla_bridge_7d_node",
            output="screen",
            parameters=[{
                "server_host":       LaunchConfiguration("server_host"),
                "server_port":       LaunchConfiguration("server_port"),
                "save_debug_images": LaunchConfiguration("save_debug_images"),
                "init_pose_tol_deg": LaunchConfiguration("home_tol_deg"),
                "wait_for_init_pose": True,
            }],
        ),
